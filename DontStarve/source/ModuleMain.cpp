...
static const int MAX_FONT_INDEX = 2; // Calling font_get_fontname on a value greater than this crashes the game as of v0.15.0
...
static const char* const HUD_FONT_NAME = "PixelMplus12"; // Changed after v0.15.0
